#Important
This is a modified version of the original Semantic Grid System. The LESS version has been updated with added functionality that allows one to reset the column gutter and width values when creating columns. This allows for nested grids that don't follow their parent grid structure.
